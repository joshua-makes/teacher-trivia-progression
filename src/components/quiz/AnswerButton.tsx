...
export function AnswerButton({
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={cn(
        'w-full text-left px-4 py-4 rounded-xl border-2 font-medium transition-all focus:outline-none focus:ring-2 focus:ring-teal-400 flex items-center gap-3 active:scale-[0.98]',
        state === 'default' &&
          !disabled &&
          'border-gray-200 dark:border-gray-700 hover:border-teal-400 hover:bg-teal-50 dark:hover:bg-teal-950/40 text-gray-800 dark:text-gray-200',
        state === 'default' &&
          disabled &&
